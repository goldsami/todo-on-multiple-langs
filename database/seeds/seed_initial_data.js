...
async function seedUsers(knex) {
  await knex('user').insert([
    {id: -5, name: 'Audrey Hepburn', description: 'Housekeeper', image_url: 'https://m.media-amazon.com/images/M/MV5BMTM4MTY3NTQyMF5BMl5BanBnXkFtZTYwMTk2MzQ2._V1_UX214_CR0,0,214,317_AL_.jpg'},
...
async function seedTasks(knex) {
  await knex('task').insert([
    {id: -5, name: 'Make the dinner', description: 'Cook pasta', user_id: -5, status: 'open', time: '2022-09-07T10:29:41.386Z'},
